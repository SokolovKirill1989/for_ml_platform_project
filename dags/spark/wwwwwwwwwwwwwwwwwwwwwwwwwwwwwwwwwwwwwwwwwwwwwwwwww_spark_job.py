...
if __name__ == "__main__":
    ...
    spark = SparkSession(sc).builder.appName("wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww_predict").enableHiveSupport().getOrCreate()
    df = f"select * from cdm.nvg_data_gr_agr_all"
